...
# 2. Descriptions
[Datasource password option](https://docs.oracle.com/en/middleware/standalone/weblogic-server/14.1.1.0/wlach/pagehelp/JDBCjdbcdatasourcesjdbcdatasourceconfigconnectionpooltitle.html) 설명에 따르면, Password는 Physical connection이 생성될 때 사용된다.
...
1 ~ 3번의 경우, 사용자 서비스가 socketRead() 와 같은 Native Method Level로 물리 DB와 연결되어 있는 경우,

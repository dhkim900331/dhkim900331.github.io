...
Coherence 12cR2 테스트 환경을 위해 기본 설치 환경을 집약한다.
...
[Oracle Software Delivery Cloud](https://edelivery.oracle.com) 에서 다운로드 하지 않고, https://download.oracle.com 에서 아직 게시되어 있었다.
...
COH_INSTALL_FILE=${BASEDIR}/fmw_12.2.1.4.0_coherence.jar
JAVA_HOME=/sw/jdk/jdk1.8.0_421

COH_INSTALL_PATH=/sw/coherence/12cR2
INVENTORY_PATH=/sw/coherence/inventories/12cR2
...
-rw-rw-r-- 1 wasadm wasadm     4337 Apr 20 15:38 tangosol-coherence-base_domain.xml
...
-rw-rw-r-- 1 wasadm wasadm     4337 Apr 20 15:24 tangosol-coherence-base_domain.xml
```

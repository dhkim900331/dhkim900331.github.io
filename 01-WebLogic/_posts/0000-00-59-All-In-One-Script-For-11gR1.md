...
WLS_INSTALL_FILE=wls1036_generic.jar
JAVA_HOME=/sw/jdk/jdk1.6.0_45

ENGINE_PATH=/sw/weblogic/11gR1
...
<bea-installer>
 <input-fields>
  <data-value name="BEAHOME" value="${ENGINE_PATH}"/>
  <data-value name="WLS_INSTALL_DIR" value="${ENGINE_PATH}/wlserver_10.3"/>
...
${JAVA_HOME}/bin/java -jar ${BASEDIR}/${WLS_INSTALL_FILE} -mode=silent -silent_xml=${BASEDIR}/silent.xml
...
${ENGINE_PATH}/wlserver_10.3/common/bin/wlst.sh << EOF
readTemplate('${ENGINE_PATH}/wlserver_10.3/common/templates/domains/wls.jar')

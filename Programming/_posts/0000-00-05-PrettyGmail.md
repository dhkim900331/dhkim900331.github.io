...
![PrettyGmail_1](/../assets_copy/posts/images/Programming/PrettyGmail_1.png)
# 3. 사용법
...
![PrettyGmail_2](/../assets_copy/posts/images/Programming/PrettyGmail_2.png){{ site.content.br_small }}
* 다음처럼 Ctrl + A를 눌러 전체 선택하거나, 제목~본문 바닥까지만 드래그한다.
  * 그러고, Ctrl + C 를 눌러 복사하고, 바로 Ctrl + V 를 누르면...

![PrettyGmail_3](/../assets_copy/posts/images/Programming/PrettyGmail_3.png){{ site.content.br_small }}
* 개발자도구모음의 Console log로 내용이 출력된다.

![PrettyGmail_4](/../assets_copy/posts/images/Programming/PrettyGmail_4.png){{ site.content.br_small }}
...
![PrettyGmail_5](/../assets_copy/posts/images/Programming/PrettyGmail_5.png)
...
layout: post
title: "[WebTier/OHS] All In One Script For 14cR2"
...
Oracle HTTP Server 14cR2 테스트 환경을 자동 재구축을 위해 모든 기본 설치 환경을 집약한다.
...
All-In-One-Script-For-14cR2.sh 실행으로 다음 환경을 구성하도록 한다.
...
OHS_INSTALL_FILE=fmw_14.1.2.0.0_ohs_linux64.bin

ENGINE_PATH=/sw/webtier/14cR2
INVENTORY_PATH=/sw/webtier/inventories/14cR2
